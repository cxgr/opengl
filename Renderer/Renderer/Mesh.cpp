...
void Mesh::CreateMesh(GLfloat* verts, unsigned numVerts, unsigned* indices, unsigned numIndices)
{
	...
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, sizeof(verts[0]) * 5, 0);
	glEnableVertexAttribArray(0);
	glVertexAttribPointer(1, 2, GL_FLOAT, GL_FALSE, sizeof(verts[0]) * 5, reinterpret_cast<void*>(sizeof(verts[0]) * 3));
